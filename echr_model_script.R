...
## britain should leave ECHR , remain in ECHR , don;t know 
...
overall_echr <- polldata %>% group_by(echr_numeric_dk_sep) %>% count()
overall_echr$pct <- 100*overall_echr$n/nrow(polldata)
...
saveRDS(model_1, "echr_model.rds")
