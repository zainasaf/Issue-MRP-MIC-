...
## will need to filter data to wales
...
# Model formulas == exlude ge_snp because it is wales only. Exclude Cosnervative - can be any party - due to colinearity- will make model 
## run faster
...
saveRDS(model_1, "bbc_bias_model.rds")
