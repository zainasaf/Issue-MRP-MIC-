...
scot_fit <- readRDS("british_pride_model_scot.RDS")
wales_fit <- readRDS("british_pride_model_wales.RDS")
eng_fit <- readRDS("british_pride_model_eng.RDS")
...
#for(j in 1:nrow(const_names)){  
  ...
  if(region == "Scotland")fit <- scot_fit
  if(region == "Wales")fit <- wales_fit
  if(!region %in% c("Scotland", "Wales"))fit <- eng_fit
  ...
  write.csv(pred_age,paste0("age_level_bbc/british_pride_preds_",const_name_i,".csv"))
  write.csv(pred_edu,paste0("edu_level_bbc/british_pride_preds_",const_name_i,".csv"))
  write.csv(pred_eth,paste0("ethn_level_bbc/british_pride_preds_",const_name_i,".csv"))
  write.csv(pred_sex,paste0("sex_level_bbc/british_pride_preds_",const_name_i,".csv"))
  write.csv(overall_pred,paste0("constituency_bbc/british_pride_preds_",const_name_i,".csv"))
  write.csv(pred_age_sex,paste0("age_sex_level_bbc/british_pride_preds_",const_name_i,".csv"))
...
write.csv(const_dat_comb, "constituency_bbc/british_pride_constituency_combined.csv")
...
write.csv(age_dat_comb, "age_level_bbc/british_pride_age_combined.csv")
...
write.csv(edu_dat_comb, "edu_level_bbc/british_pride_edu_combined.csv")
...
write.csv(ethn_dat_comb, "ethn_level_bbc/british_pride_ethn_combined.csv")
...
write.csv(sex_dat_comb, "sex_level_bbc/british_pride_sex_combined.csv")
...
write.csv(age_sex_dat_comb, "age_sex_level_bbc/british_pride_combined.csv")
